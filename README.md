...
**1、新增了第三方节点链接的导入，该功能仅用于落地，目前仅支持VLESS (Vision+REALITY)、Hysteria2、TUICv5、Shadowsocks这四种第三方节点链接的导入，脚本内部会生成VLESS-TCP、Shadowsocks两种适配层协议，生成好了以后在进阶功能——落地机配置处即可选择生成的适配层协议生成转发Token，操作用法同上第三点。**

**2、新增了节点端口修改，主脚本与子脚本所存在节点都可以单独修改端口，修改好后的各项信息会逐一同步。**
