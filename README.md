...
**1、内置的Relay转发灵感来自[singbox-deploy](https://github.com/caigouzi121380/singbox-deploy)**
...
输入一个未被使用的端口和SIN伪装域名即可，最后会输出一个节点链接。**

**3、生成的节点链接导入到V2rayN即可正常使用。通过线路机的VLESS (Vision+REALITY)将流量转发到落地机，落地机访问后返回数据。**
