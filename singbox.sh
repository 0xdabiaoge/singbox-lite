...
_add_hysteria2() {
    ...
    local tag="hy2-in-${port}"; local name="Hysteria2-${port}"; local display_ip="$node_ip"; [[ "$node_ip" == *":"* ]] && display_ip="[$node_ip]"
...
_add_tuic() {
    ...
    local tag="tuic-in-${port}"; local name="TUICv5-${port}"; local display_ip="$node_ip"; [[ "$node_ip" == *":"* ]] && display_ip="[$node_ip]"
